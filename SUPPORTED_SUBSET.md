...
| `IF condition` | `if cond:` / `else:` | Multi-line: full translation; inline: condition translated, body TODO |
...
4. **Inline IF/EVALUATE** — Single-line IF/EVALUATE have condition translated but body as TODO
